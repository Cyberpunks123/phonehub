...
<body>
            ...
            <div class="row">
                    ...
                    <table cellspacing="0" class="shop_table cart">
                        <thead>
                            <tr>
                                ...
                                <th class="product-subtotal">Product sStatus</th>
                            </tr>
                        </thead>
                ...
                <div class="cart-collaterals">
                    ...
                    <div class="cart_totals ">
                        ...
                        <h2>Total Amount of Checkout items</h2>
                        ...
                        <?php
            if(empty($cartlist)){ ?>
                        <a href="#noitems" data-toggle="modal" data-target="#noitems"><button type="button" class="btn btn-primary">Pay now</button></a>
                        <?php    }
                else{ ?>
                            ...
                            <div class="panel panel-default">
                                ...
                                <form action="includes/updateCrtStat.inc.php" method="POST">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <input type="hidden" name="mySess" value="<?php echo $_SESSION['USER']?>">
    ...
    <!--    --------------------------------------------------   -->
    <div class="modal fade" id="noitems" tabindex="-1" role="dialog" aria-labelledby="noitems" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-danger">
                        <strong class="alert-text-danger">Action cannot be done. Checkout is Empty!</strong>
                    </div>
